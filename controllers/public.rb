...
module Firebots
  module InternalAPI::Controllers
    ...
    class Public < Kenji::Controller
      ...
      get '/about' do
        url = 'https://gist.githubusercontent.com/glinia/f65b98b347cc12816c36/raw/about.md'
      ...
      get '/important-info' do
        url = 'https://gist.githubusercontent.com/glinia/7a9e39020c0276c3034a/raw/important-info.md'
